...
class WebViewViewController: UIViewController {
    ...
    private let loaderView: NVActivityIndicatorView = {
        ...
        v.color = UIColor(hexFromString: "001D3D")
...
//        (tabBarController as? CustomTabBarController)?.setTabBar(hidden: false)
    ...
    private func setupView() {
        view.backgroundColor = .white
        navigationController?.navigationBar.barTintColor = UIColor(hexFromString: "001D3D")
    ...
    private func webViewConstraints() {
        webView.topAnchor.constraint(equalTo: webView.superview!.safeTopAnchor).isActive = true
    ...
    private func laoderViewConstraints() {
        ...
        loaderView.widthAnchor.constraint(equalToConstant: CGFloat(35)).isActive = true
        loaderView.heightAnchor.constraint(equalToConstant: CGFloat(35)).isActive = true
